...
<body>
     <div>
		 <H1>Reporte de Mantenimientos &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-danger oculto-impresion" onclick="window.location='../index_b.php'">Close</button>
